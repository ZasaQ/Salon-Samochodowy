...
public class Samochody {
  ...
  public String getLine(int line) throws IOException{
      return Files.lines(Paths.get("C:/Users/Student/Desktop/untitled1/src/baza.txt")).skip(line-1).findFirst().get();
  }
  ...
  public int ileLinii() throws FileNotFoundException {
      File plik = new File("C:/Users/Student/Desktop/untitled1/src/baza.txt");
